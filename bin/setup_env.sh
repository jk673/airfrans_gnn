...
echo ""
echo " To start training with custom defaults:"
echo "   Edit scripts/train.py Config dataclass, then run:"
echo "   python scripts/train.py"
echo ""
echo " For tuning instructions, see docs/training/README.md."
echo "=================================================================="
