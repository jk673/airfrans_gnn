"""
Boundary-region diagnostic statistics for AirfRANS GNN evaluation.

Computes per-region (wall, inlet, outlet, farfield, interior) error breakdowns
including MAE, relative L2, percentiles, and CFD-specific diagnostics.
"""
