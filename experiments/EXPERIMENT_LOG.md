...
Auto-generated benchmark comparison. Updated: 2026-02-18 20:52:57 UTC
...
| **EXP_0005** (scarce-h32-l14) | 0.3825 | 0.3964 | 1.8748 | 0.5437 | 0.8636 | 0.7647 |
| **EXP_0006** (scarce-h32-l14) | 0.4422 | 0.4576 | 3.1857 | 0.6608 | 0.8984 | 0.6477 |

---

## Experiment Details

### EXP_0006 — 2026-02-18 20:52:57 UTC

**Model:** scarce-h32-l14 | **Task:** scarce | **Parameters:** 232,036 | **Duration:** 18m 20s

**Notes:** task=scarce, hidden=32, layers=14, lr=0.0004, scheduler=cosine

| Benchmark Metric | Value |
|--------|-------|
| volume_rel_l2 | 0.4422 |
| surface_rel_l2 | 0.4576 |
| cd_relative_error | 3.1857 |
| cl_relative_error | 0.6608 |
| rho_d | 0.8984 |
| rho_l | 0.6477 |
...
|--------|-------|
| status | completed |
| best_val_loss | 0.0823 |
| best_epoch | 192 |
| finalloss | 0.2360 |
| final_val_loss | 0.0970 |
...
### EXP_0005 — 2026-02-18 18:51:22 UTC

**Model:** scarce-h32-l14 | **Task:** scarce | **Parameters:** 232,036 | **Duration:** 28m 37s

**Notes:** task=scarce, hidden=32, layers=14, lr=0.0004, scheduler=cosine

| Benchmark Metric | Value |
|--------|-------|
| volume_rel_l2 | 0.3825 |
| surface_rel_l2 | 0.3964 |
| cd_relative_error | 1.8748 |
| cl_relative_error | 0.5437 |
| rho_d | 0.8636 |
| rho_l | 0.7647 |
...
|--------|-------|
| status | completed |
| best_val_loss | 0.0570 |
| best_epoch | 184 |
| finalloss | 0.2016 |
| final_val_loss | 0.0601 |
| artifacts_uploaded | 0 |
